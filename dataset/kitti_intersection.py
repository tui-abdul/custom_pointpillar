...
class KittiIntersection(Dataset):
    ...
    def __init__(self, data_root, split, pts_prefix='velodyne_reduced'):
        ...
        self.data_aug_config=dict(
            ...
            point_range_filter=[0, -39.68, -5, 69.12, 39.68, 1],
            object_range_filter=[0, -39.68, -5, 69.12, 39.68, 1]             
        )
    ...
    def __getitem__(self, index):
        ...
        #print("gt_bboxes location dimension rotation",annos_location, annos_dimension, rotation_y)
        #print("path",pts_path)
