...
def dbsample(CLASSES, data_root, data_dict, db_sampler, sample_groups):
    ...
    return: data_dict
    '''
    velodyne_path = data_dict['velodyne_path']
    #print("data",data_dict )
    #print("gt_difficulty",data_dict["difficulty"])
    ...
    for name, v in sample_groups.items():
        ...
        if sampled_num <= 0:
            continue
        #print("db_sampler",db_sampler['car'].) 
        
        #print("name",name)
        #print("gt_names",gt_names)
        #print("sampled_num",sampled_num)
        #print("db_sampler[name]",db_sampler[name].sample(sampled_num))
        ...
        #print("sampled_cls_bboxes",sampled_cls_bboxes.shape)
        #print("sampled_cls_list",sampled_cls_list)
